...
import 'package:flutter_netease_cloud_music/view/widgets/widget_sliver_future_builder.dart';
import 'package:flutter_screenutil/screenutil.dart';
import 'state.dart';

Widget buildView(dailysongsState state, Dispatch dispatch, ViewService viewService) {
  ...
  return Scaffold(
    ...
    body: Stack(
      children: <Widget>[
        Padding(
          padding: EdgeInsets.only(bottom: ScreenUtil().setWidth(80) + ScreenUtil.bottomBarHeight),
